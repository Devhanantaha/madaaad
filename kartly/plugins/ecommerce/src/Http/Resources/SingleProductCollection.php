...
class SingleProductCollection extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'review_summary' => $this->productReviewSummary($this->id),
        ];
    }
    ...
    public function galleryImages()
    {
        ...
        $thumbnail = [];
        $thumbnail['regular'] = getFilePath($this->thumbnail_image, true, '1000x1000');
        $thumbnail['zoom'] = getFilePath($this->thumbnail_image, true, '1000x1000');
        $thumbnail['type'] = 'image';
        array_push($images, $thumbnail);

        if (count($this->color_images) > 0 && count($this->color_choices) > 0) {
