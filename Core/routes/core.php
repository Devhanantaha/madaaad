...
use Core\Http\Controllers\LicenseController;
...
Route::post('email-reset-password-link', [AuthenticationController::class, 'emailResetPasswordLink'])->name('core.email.reset.password.link')->middleware('demo');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'contact'], function () {
        Route::get('/messages', [ContactMessageController::class, 'index'])->name('core.contact.messages');
        Route::post('delete/messages', [ContactMessageController::class, 'delete'])->name('core.contact.messages.delete')->middleware('demo');
    });
    ...
    Route::middleware(['can:Manage Language'])->group(function () {
        ...
        Route::post('/change-language-rtl', [LanguageController::class, 'changeLanguageRtl'])->name('core.language.change.rtl')->middleware('demo');
        Route::post('/change-language-status', [LanguageController::class, 'changeLanguageStatus'])->name('core.language.change.status')->middleware('demo');
    ...
    Route::post('/delete-theme-translations', [LanguageController::class, 'deleteThemeTranslations'])->name('core.language.theme.translations.delete')->middleware('demo');
    ...
    Route::post('/update-media-file-info', [MediaController::class, 'updateMediaFileInfo'])->name('core.update.media.file.info')->middleware('demo');
    ...
    Route::group(['prefix' => 'business'], function () {
        ...
        Route::post('/send-test-email', [EmailController::class, 'sendTestMail'])->name('core.email.send.test')->middleware('demo');
        //Email template
    ...
    Route::post('/update-mood', [StyleController::class, 'changeMood'])->name('core.mood.change')->middleware('demo');
    ...
    Route::controller(PageController::class)->group(function () {
        ...
        Route::post('/page-change-status', 'pageStatusChange')->name('core.page.status.change')->middleware(['can:Edit Page', 'demo']);
    ...
    Route::post('/admin-notification-mark-as-read', [NotificationController::class, 'adminNotificationMarkAsRead'])->name('core.admin.notification.mark.as.read.single')->middleware('demo');
    Route::post('/admin-notification-mark-as-read-all', [NotificationController::class, 'adminAllNotificationMarkAsRead'])->name('core.admin.notification.mark.as.read.all')->middleware('demo');
    ...
    Route::group(['prefix' => 'backup'], function () {
        ...
        Route::post('delete-backup-file', [BackupController::class, 'fileBackupDelete'])->name('core.backup.files.delete')->middleware(['demo', 'can:Manage Backups', 'demo']);
    ...
    Route::group(['prefix' => 'license'], function () {
        Route::get('list', [LicenseController::class, 'index'])->name('core.license.list')->middleware(['demo']);
        Route::post('remove', [LicenseController::class, 'remove'])->name('core.license.remove');
