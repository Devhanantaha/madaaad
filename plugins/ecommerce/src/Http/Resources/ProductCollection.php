        ...
        return [
            'data' => $this->collection->map(function ($data) {
                return [
                    ...
                    'slug' => $data->permalink,
                    'thumbnail_image' => asset(getFilePath($data->thumbnail_image, true, '250x250')),
                    ...
                    'attatchment_title' => $data->is_active_attatchment != config('settings.general_status.active') ? null : $data->attatchment_name,
