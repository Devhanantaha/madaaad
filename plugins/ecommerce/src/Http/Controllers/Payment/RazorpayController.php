...
class RazorpayController extends Controller
{
    ...
    public function config($payment_queue)
    {
        ...
        return [
            ...
            'total_payable_amount' => $orderAmount,
            'key_id' => $this->key_id,
    ...
    public function paymentStatus(Request $request)
    {
        try {
            ...
            if ($payment['status'] == 'captured') {
                // Payment captured, process the order
                return (new PaymentController)->payment_success($pi, "Payment-ID " . $paymentId);
            } else {
