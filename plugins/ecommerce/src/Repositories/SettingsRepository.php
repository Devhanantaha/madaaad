...
class SettingsRepository
{
    ...
    {
        $currency = Currency::where('id', self::getEcommerceSetting('default_currency'))
            ->select('id', 'name', 'code', 'symbol', 'conversion_rate', 'position', 'thousand_separator', 'decimal_separator', 'number_of_decimal')
            ->first();

        if ($currency == null) {
            $currency = Currency::where('status', config('settings.general_status.active'))
                ->select('id', 'name', 'code', 'symbol', 'conversion_rate', 'position', 'thousand_separator', 'decimal_separator', 'number_of_decimal')
                ->first();
        }
    ...
    /**
     * Will update e-commerce settings
     * 
     * @param Object $request
     * @return bool
     */
    public function updateEcommerceSettings($request)
    {
        try {
            DB::beginTransaction();
            $settings = [
                'enable_country_state_city_in_checkout'    => $request->has('enable_country_state_city_in_checkout') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
                ...
                'only_verified_customer_left_review'       => $request->has('only_verified_customer_left_review') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
                ...
                //Wallet Settings
                'enable_minimum_order_amount'              => $request->has('enable_minimum_order_amount') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
                ...
                'customer_email_verification'              => $request->has('customer_email_verification') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
                ...
                'enable_pickup_point_in_checkout'           => $request->has('enable_pickup_point_in_checkout') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
                'order_code_prefix_separator'              => $request->has('order_code_prefix_separator') ? $request['order_code_prefix_separator'] : null,
                //Invoice Settings
                ...
                'privacy_policy_page'                      => $request->has('privacy_policy_page') ? $request['privacy_policy_page'] : null,
                'return_policy_page'                       => $request->has('return_policy_page') ? $request['return_policy_page'] : null,
    ...
    public static function siteSettings()
    {
        try {
            $data = [
                ...
                'only_verified_customer_left_review'      => self::getEcommerceSetting('only_verified_customer_left_review'),
                ...
                'privacy_policy_page_slug'                => self::getEcommerceSetting('privacy_policy_page') != null ? self::getPageUrl(self::getEcommerceSetting('privacy_policy_page')) : '#',
                'return_policy_page_slug'                 => self::getEcommerceSetting('return_policy_page') != null ? self::getPageUrl(self::getEcommerceSetting('return_policy_page')) : '#',
                ...
                'enable_minimum_order_amount'             => self::getEcommerceSetting('enable_minimum_order_amount'),
                ...
                'enable_pickup_point_in_checkout'          => self::getEcommerceSetting('enable_pickup_point_in_checkout'),
                ...
                'enable_country_state_city_in_checkout'   => self::getEcommerceSetting('enable_country_state_city_in_checkout') != null && self::getEcommerceSetting('enable_country_state_city_in_checkout') == config('settings.general_status.active') ? config('settings.general_status.active') : config('settings.general_status.in_active'),
            ];
