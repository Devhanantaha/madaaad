...
class SellerRepository
{
    ...
    public function storeSeller($data)
    {
        ...
        try {
            ...
            $seller->status = get_setting('seller_auto_verification') == config('settings.general_status.active') ? config('settings.general_status.active') : config('settings.general_status.in_active');
    ...
    public function storeSellerShop($seller_id, $data)
    {
        ...
        $seller_shop->status = get_setting('seller_auto_verification') == config('settings.general_status.active') ? config('settings.general_status.active') : config('settings.general_status.in_active');
        $seller_shop->save();
    }
    /**
