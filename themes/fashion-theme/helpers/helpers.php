    ...
    function getMenuStructureByGroupId($group_id)
    {
        ...
        for ($i = 0; $i < sizeof($data); $i++) {
            ...
            if ($data[$i]->icon == null || $data[$i]->icon == 'null' || $data[$i]->icon == '' ||  $data[$i]->icon == ' ') {
                ...
                if (Session::get('api_locale') != null && Session::get('api_locale') != defaultLanguage()) {
                    $translated_title = getTranslatedMenuTitle($data[$i]->id, Session::get('api_locale'), $data[$i]->title);
                    $data[$i]->title = $translated_title;
                } else {
                    $translated_title = getTranslatedMenuTitle($data[$i]->id, defaultLanguage(), $data[$i]->title);
                    $data[$i]->title = $translated_title;
                }
            } else {
...
if (!function_exists('commentClose')) {
    ...
    {
        $comment_close_date = date('Y-m-d', strtotime($publish_at . ' + ' . get_setting('close_comments_days_old') . ' days'));
        ...
        if ($custom_options[$custom_font_number] == '1') {
            ...
            if ($font_woff_file != '') {
                if (isset($customFontFace['src']) && $customFontFace['src'] != '') {
                    $customFontFace['src'] = $customFontFace['src'] . ',' . "url('" . asset('themes/fashion-theme/public/' . $custom_font_number . '/' . $font_woff_file) . "')";
                } else {
                    $customFontFace['src'] = "url('" . asset('themes/fashion-theme/public/' . $custom_font_number . '/' . $font_woff_file) . "')";
                }
            }

            if ($font_ttf_file != '') {
                if (isset($customFontFace['src']) && $customFontFace['src'] != '') {
                    $customFontFace['src'] = $customFontFace['src'] . ',' . "url('" . asset('themes/fashion-theme/public/' . $custom_font_number . '/' . $font_ttf_file) . "')";
                } else {
                    $customFontFace['src'] = "url('" . asset('themes/fashion-theme/public/' . $custom_font_number . '/' . $font_ttf_file) . "')";
                }
            }

            if ($font_eot_file != '') {
                if (isset($customFontFace['src']) && $customFontFace['src'] != '') {
                    $customFontFace['src'] = $customFontFace['src'] . ',' . "url('" . asset('themes/fashion-theme/public/' . $custom_font_number . '/' . $font_eot_file) . "')";
                } else {
                    $customFontFace['src'] = "url('" . asset('themes/fashion-theme/public/' . $custom_font_number . '/' . $font_eot_file) . "')";
                }
            }
        }
